...
function HeroSection() {
  ...
  <h1 className="text-3xl font-bold leading-10 text-white md:font-extrabold lg:text-5xl lg:leading-14 animate-float">
    Hello, <br />
    I&apos;m {' '}
  ...
  <div className="my-12 flex items-center gap-5">
    <Link
      ...
      target='_blank'
      className="transition-all text-pink-500 hover:text-white duration-300 transform hover:scale-110"
    >
      <BsGithub size={30} />
    </Link>
    <Link
  ...
  <div className="flex items-center gap-3">
    <Link href="#contact" className="bg-gradient-to-r to-pink-500 from-violet-600 p-[1px] rounded-full flex-1 transition-all duration-300 hover:from-pink-500 hover:to-violet-600">
      <button className="w-full px-3 py-2 md:px-6 md:py-3 bg-[#0d1224] rounded-full text-white uppercase tracking-wider font-medium text-sm flex items-center justify-center hover:bg-transparent hover:border-pink-500 hover:text-white transition-all duration-200 ease-out transform hover:shadow-purple-500">
    ...
    <Link href={personalData.resume} target="_blank" className="flex items-center gap-2 rounded-full bg-gradient-to-r from-pink-500 to-violet-600 px-3 py-2 md:px-6 md:py-3 text-white uppercase tracking-wider font-medium text-sm hover:text-white hover:from-violet-600 hover:to-pink-500 transition-all duration-200 ease-out transform hover:shadow-purple-500">
      ...
      <MdDownload size={14} className="ml-1" />
        ...
        <div className="order-1 lg:order-2 relative rounded-lg bg-gradient-to-r from-[#0d1224] to-[#0a0d37] border-[#1b2c68a0] shadow-xl hover:shadow-purple-500 transition-shadow duration-500 ease-in-out transform hover:-translate-y-1">
      <style jsx>{`
      ...
      <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
        <code className="font-mono text-xs md:text-sm lg:text-base">
          ...
          <div>
            <span className="ml-4 lg:ml-8 text-white">quickLearner:</span>
            <span className="text-orange-400">true</span>
            <span className="text-gray-400">,</span>
          </div>
          <div>
            <span className="ml-4 lg:ml-8 text-white">highlyCommitted:</span>
            <span className="text-orange-400">true</span>
            <span className="text-gray-400">,</span>
          </div>
          <div>
            <span className="ml-4 lg:ml-8 text-white">teamOriented:</span>
            <span className="text-orange-400">true</span>
            <span className="text-gray-400">,</span>
          </div>
          <div>
